...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        String addPessoaSQL = "INSERT INTO pessoa (id, nome, qtdAcesso, naturalidade) values (1, 'Kelvin', 4, 'brasileiro')";
        Statement statement = conexao.createStatement();
        statement.executeUpdate(addPessoaSQL);
        ...
        while (resultado.next()) {
            ...
            System.out.println("qtdAcesso: " + pessoa.getQuantidadeAcesso());
